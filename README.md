...
- [Array](#3-array)
- [Tuple](#4-tuple)
- [Object & Type & Interface](#5-object--type--interface)
- [Enum](#6-enum)
- [Alias & Literal Types](#7-alias--literal-types)
- [Type Assertion](#8-type-assertion)
- [TS Classes ](#9-ts-classes)
- [Index Signature, typeof Assertion & Record utility ](#10-index-signature-typeof-assertion--record-utility)
- [TS Generics ](#11-ts-generics)
- [Utility](#12-utility)
